...
@Component({
  selector: 'app-modificar-Agregar',
  templateUrl: './modificar-Agregar.component.html',
  styleUrls: ['./modificar-Agregar.component.css']
})
export class ModificarAgregarComponent implements OnInit {
